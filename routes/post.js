...
router.route('/').get(pagination, requiredFields, postController.list);

/* POST request to create a Post */
router.route('/').post(postController.store);

/* GET request to show a Post */
router.route('/:postId').get(requiredFields, postController.show)
...
router.route('/:postId/comments').get(pagination, requiredFields, postController.commentList);

/* GET request to show a Post */
router.route('/:postId/comments/:commentId').get(requiredFields, postController.showComment)
